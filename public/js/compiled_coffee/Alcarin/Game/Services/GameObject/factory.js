...
namespace('Alcarin.Game.Services.GameObject', function(exports, Alcarin) {
  var factories, module, resolvingGameObject;

  factories = [];
  resolvingGameObject = function(resolving_method, GameServer, obj) {
    return function() {
      return Q(resolving_method(GameServer, obj));
    };
  };
  exports.Factory = {
    register: function(can_resolve, resolving_method) {
        ...
        for (_i = 0, _len = factories.length; _i < _len; _i++) {
          ...
          if (factory.condition(arg)) {
            (function(factory, arg) {
              return arg.resolve = resolvingGameObject(factory.resolving, GameServer, arg);
            })(factory, arg);
            return arg;
          }
        }
